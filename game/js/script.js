...
function startGame(){
    ...
    if(winner === 0) window.prompt("DRAW")
    else if(winner === 1) window.prompt("Player 1 wins")
    else window.prompt("Player 2 wins")
...
function selectColumn(column){
    ...
    if(winner === 1) confirm(`player 1 wins`)
    else if(winner === 2) confirm(`player 2 wins`)
    else if(emptySpaces(board) === 0) confirm(`Draw! Please refresh to restart`)
}
